...
def conv_forward(A_prev, W, b, hparameters):
    ...
    print("Input", n_H_prev, n_W_prev, n_C_prev)
    print("Input with pad", A_prev_pad.shape)
    print("Params", stride, pad)
    print("output", n_H, n_W, n_C)
...
def pool_forward(A_prev, hparameters, mode = "max"):
    ...
    print("Input", A_prev.shape)
    print("Params", f, stride)
